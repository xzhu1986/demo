...
curse:"Curse",crazy:"Crazy",angry:"Angry",ohmy:"Oh my",awkward:"Awkward",panic:"Panic",shy:"Shy",cute:"Cute",envy:"Envy",proud:"Proud",struggle:"Struggle",quiet:"Quiet",shutup:"Shut up",doubt:"Doubt",despise:"Despise",sleep:"Sleep",bye:"Bye"}}},ka={Cut:{t:"Cut (Ctrl+X)"},Copy:{t:"Copy (Ctrl+C)"},Paste:{t:"Paste (Ctrl+V)"},Pastetext:{t:"Paste as plain text",h:i?0:1},Blocktag:{t:"Block tag",h:1},Fontface:{t:"Font family",h:1},FontSize:{t:"Font size",h:1},Bold:{t:"Bold (Ctrl+B)",s:"Ctrl+B"},Italic:{t:"Italic (Ctrl+I)",
...
"i")))if(c){if(c!==b[1])return 2}else c=b[1];else return 1;return c}(b);1===f?alert("Upload file extension required for this: "+h.replace(/\w+:,/g,"")):2===f?alert("You can only drag and drop the same type of files."):f&&c.startUpload(b,g["up"+f+"Url"],"*",function(a){var b=[],e;(e=g.onUpload)&&e(a);for(var r=0,j=a.length;r<j;r++)e=a[r],url=M(e,"string")?e:e.url,"!"===url.substr(0,1)&&(url=url.substr(1)),b.push(url);c.exec(f);d("#xhe"+f+"Url").val(b.join(" "));d("#xheSave").click()});return!1}});
(j=g.shortcuts)&&d.each(j,function(a,b){c.addShortcuts(a,b)});aa++;Ma=!0;g.fullscreen?c.toggleFullscreen():g.sourceMode&&setTimeout(c.toggleSource,20);return!0};this.remove=function(){c.hidePanel();U();F.unbind("focus",c.focus);Ya.unbind("submit",U).unbind("reset",I);g.submitID&&d("#"+g.submitID).unbind("mousedown",U);d(window).unbind("unload beforeunload",U).unbind("resize",Na);d(document).unbind("mousedown",Oa);d("#"+ja).remove();d("#"+za).remove();F.show();Ma=!1};this.saveBookmark=function(){if(!y){c.focus();
var a=c.getRng(),a=a.cloneRange?a.cloneRange():a;ha={top:fa.scrollTop(),rng:a}}};this.loadBookmark=function(){if(!y&&ha){c.focus();var a=ha.rng;if(i)a.select();else{var b=c.getSel();b.removeAllRanges();b.addRange(a)}fa.scrollTop(ha.top);ha=null}};this.focus=function(){y?d("#sourceCode",k).focus():W.focus();if(i){var a=c.getRng();a.parentElement&&a.parentElement().ownerDocument!==k&&c.setTextCursor()}return!1};this.setTextCursor=function(a){var b=c.getRng(!0),e=k.body;if(i)b.moveToElementText(e);else{for(var d=
a?"lastChild":"firstChild";3!=e.nodeType&&e[d];)e=e[d];b.selectNode(e)}b.collapse(a?!1:!0);i?b.select():(a=c.getSel(),a.removeAllRanges(),a.addRange(b))};this.getSel=function(){return k.selection?k.selection:W.getSelection()};this.getRng=function(a){var b,e;try{a||(b=c.getSel(),e=b.createRange?b.createRange():0<b.rangeCount?b.getRangeAt(0):null),e||(e=k.body.createTextRange?k.body.createTextRange():k.createRange())}catch(d){}return e};this.getParent=function(a){var b=c.getRng(),e;i?e=b.item?b.item(0):
b.parentElement():(e=b.commonAncestorContainer,b.collapsed||b.startContainer===b.endContainer&&2>b.startOffset-b.endOffset&&b.startContainer.hasChildNodes()&&(e=b.startContainer.childNodes[b.startOffset]));a=a?a:"*";e=d(e);e.is(a)||(e=d(e).closest(a));return e};this.getSelect=function(a){var b=c.getSel(),e=c.getRng(),f=!0,f=!e||e.item?!1:!b||0===e.boundingWidth||e.collapsed;if("text"===a)return f?"":e.text||(b.toString?b.toString():"");e.cloneContents?(a=d("<div></div>"),(e=e.cloneContents())&&a.append(e),
e=a.html()):e=M(e.item)?e.item(0).outerHTML:M(e.htmlText)?e.htmlText:e.toString();f&&(e="");e=c.processHTML(e,"read");e=c.cleanHTML(e);return e=c.formatXHTML(e)};this.pasteHTML=function(a,b){if(y)return!1;c.focus();var a=c.processHTML(a,"write"),e=c.getSel(),f=c.getRng();if(b!==$){if(f.item){var h=f.item(0),f=c.getRng(!0);f.moveToElementText(h);f.select()}f.collapse(b)}a+="<"+(i?"img":"span")+' id="_xhe_temp" width="0" height="0" />';if(f.insertNode){if(0<d(f.startContainer).closest("style,script").length)return!1;
f.deleteContents();f.insertNode(f.createContextualFragment(a))}else"control"===e.type.toLowerCase()&&(e.clear(),f=c.getRng()),f.pasteHTML(a);var h=d("#_xhe_temp",k),n=h[0];i?(f.moveToElementText(n),f.select()):(f.selectNode(n),e.removeAllRanges(),e.addRange(f));h.remove()};this.pasteText=function(a,b){a||(a="");a=c.domEncode(a);a=a.replace(/\r?\n/g,"<br />");c.pasteHTML(a,b)};this.appendHTML=function(a){if(y)return!1;c.focus();a=c.processHTML(a,"write");d(k.body).append(a);c.setTextCursor(!0)};this.domEncode=
function(a){return a.replace(nb,function(a){return mb[a]})};this.setSource=function(a){ha=null;if("string"!==typeof a&&""!==a)a=z.value;y?d("#sourceCode",k).val(a):(g.beforeSetSource&&(a=g.beforeSetSource(a)),a=c.cleanHTML(a),a=c.formatXHTML(a),a=c.processHTML(a,"write"),i?(k.body.innerHTML='<img id="_xhe_temp" width="0" height="0" />'+a,d("#_xhe_temp",k).remove()):k.body.innerHTML=a)};this.processHTML=function(a,b){if("write"===b){a=a.replace(/(<(\/?)(\w+))((?:\s+[\w\-:]+\s*=\s*(?:"[^"]*"|'[^']*'|[^>\s]+))*)\s*((\/?)>)/g,
...
d.replace(/\s+emot\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/i,function(a,b){m=b.match(/^(["']?)(.*)\1/)[2];m=m.split(",");m[1]||(m[1]=m[0],m[0]="");"default"===m[0]&&(m[0]="");return g.emotMark?a:""});else if("a"===e)!d.match(/ href=[^ ]/i)&&d.match(/ name=[^ ]/i)&&(x+=" xhe-anchor"),h&&(f="></a>");else if("table"===e&&!c&&(a=d.match(/\s+border\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/i),!a||a[1].match(/^(["']?)\s*0\s*\1$/)))x+=" xhe-border";var Z,d=d.replace(/\s+([\w\-:]+)\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/g,function(a,
b,c){b=b.toLowerCase();c=c.match(/^(["']?)(.*)\1/)[2];aft="";if(i&&b.match(/^(disabled|checked|readonly|selected)$/)&&c.match(/^(false|0)$/i)||"img"===e&&m&&"src"===b)return"";b.match(/^(src|href)$/)&&(aft=" _xhe_"+b+'="'+c+'"',B&&(c=V(c,"abs",B)));x&&"class"===b&&(c+=" "+x,x="");R&&"style"===b&&"span"===e&&c.match(/(^|;)\s*(font-family|font-size|color|background-color)\s*:\s*[^;]+\s*(;|$)/i)&&(Z=!0);return" "+b+'="'+c+'"'+aft});m&&(a=Y+(m[0]?m[0]:"default")+"/"+m[1]+".gif",d+=' src="'+a+'" _xhe_src="'+
a+'"');Z&&(d+=' class="Apple-style-span"');x&&(d+=' class="'+x+'"');return"<"+c+e+d+f});i&&(a=a.replace(/&apos;/ig,"&#39;"));if(!R)var e=function(a,b,e,c,d,f){var b="",h,m;(h=c.match(/font-family\s*:\s*([^;"]+)/i))&&(b+=' face="'+h[1]+'"');if(h=c.match(/font-size\s*:\s*([^;"]+)/i)){h=h[1].toLowerCase();for(var x=0;x<T.length;x++)if(h===T[x].n||h===T[x].s){m=x+1;break}m&&(b+=' size="'+m+'"',c=c.replace(/(^|;)(\s*font-size\s*:\s*[^;"]+;?)+/ig,"$1"))}if(m=c.match(/(?:^|[\s;])color\s*:\s*([^;"]+)/i)){if(h=
...
"editMode"+Q),i?b.contentEditable="true":k.designMode="On",qa&&(c._exec("inserthtml","-"),d("#"+za).show().focus().hide()),g="Source mode";else{c.pasteHTML('<span id="_xhe_cursor"></span>',!0);f=c.getSource(!0);a=f.indexOf('<span id="_xhe_cursor"></span>');if(!Ca)a=f.substring(0,a).replace(/\r/g,"").length;f=f.replace(/(\r?\n\s*|)<span id="_xhe_cursor"><\/span>(\s*\r?\n|)/,function(a,b,c){return b&&c?"\r\n":b+c});i?b.contentEditable="false":k.designMode="Off";e.attr("scroll","no").attr("class","sourceMode").html('<textarea id="sourceCode" wrap="soft" spellcheck="false" style="width:100%;height:100%" />');
h=d("#sourceCode",e).blur(c.getSource)[0];g="WYSIWYG mode"}y=!y;c.setSource(f);c.focus();y?h.setSelectionRange?h.setSelectionRange(a,a):(h=h.createTextRange(),h.move("character",a),h.select()):c.setTextCursor();q.find("[cmd=Source]").attr("title",g).find("span").text(g);q.find("[cmd=Source],[cmd=Preview]").toggleClass("xheEnabled");q.find(".xheButton").not("[cmd=Source],[cmd=Fullscreen],[cmd=About]").toggleClass("xheEnabled").attr("aria-disabled",y?!0:!1);setTimeout(La,300)}};this.showPreview=function(){var a=
g.beforeSetSource,b=c.getSource();a&&(b=a(b));var a="<html><head>"+P+"<title>Preview</title>"+(B?'<base href="'+B+'"/>':"")+"</head><body>"+b+"</body></html>",b=window.screen,b=window.open("","xhePreview","toolbar=yes,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,width="+Math.round(0.9*b.width)+",height="+Math.round(0.8*b.height)+",left="+Math.round(0.05*b.width)),e=b.document;e.open();e.write(a);e.close();b.focus()};this.toggleFullscreen=function(a){if(la!==a){var a=d("#"+ja).find(".xheLayout"),
b=d("#"+ja),e=jQuery.browser.version,e=i&&(6==e||7==e);la?(e&&F.after(b),a.attr("style",Za),A.height(O-q.outerHeight()),d(window).scrollTop(Pa),setTimeout(function(){d(window).scrollTop(Pa)},10)):(e&&d("body").append(b),Pa=d(window).scrollTop(),Za=a.attr("style"),a.removeAttr("style"),A.height("100%"),setTimeout(Na,100));qa?(d("#"+za).show().focus().hide(),setTimeout(c.focus,1)):e&&c.setTextCursor();la=!la;b.toggleClass("xhe_Fullscreen");d("html").toggleClass("xhe_Fullfix");q.find("[cmd=Fullscreen]").toggleClass("xheActive");
setTimeout(La,300)}};this.showMenu=function(a,b){var e=d('<div class="xheMenu"></div>'),f=a.length,h=[];d.each(a,function(a,b){"-"===b.s?h.push('<div class="xheMenuSeparator"></div>'):h.push("<a href=\"javascript:void('"+b.v+'\')" title="'+(b.t?b.t:b.s)+'" v="'+b.v+'" role="option" aria-setsize="'+f+'" aria-posinset="'+(a+1)+'" tabindex="0">'+b.s+"</a>")});e.append(h.join(""));e.click(function(a){a=a.target;if(!d.nodeName(a,"DIV"))return c.loadBookmark(),b(d(a).closest("a").attr("v")),c.hidePanel(),
!1}).mousedown(N);c.saveBookmark();c.showPanel(e)};this.showColor=function(a){var b=d('<div class="xheColor"></div>'),e=[],f=Ta.length,h=0;d.each(Ta,function(a,b){0===h%7&&e.push((0<h?"</div>":"")+"<div>");e.push("<a href=\"javascript:void('"+b+'\')" xhev="'+b+'" title="'+b+'" style="background:'+b+'" role="option" aria-setsize="'+f+'" aria-posinset="'+(h+1)+'"></a>');h++});e.push("</div>");b.append(e.join(""));b.click(function(b){b=b.target;if(d.nodeName(b,"A"))return c.loadBookmark(),a(d(b).attr("xhev")),
c.hidePanel(),!1}).mousedown(N);c.saveBookmark();c.showPanel(b)};this.showPastetext=function(){var a=d('<div><label for="xhePastetextValue">Use Ctrl+V on your keyboard to paste the text.</label></div><div><textarea id="xhePastetextValue" wrap="soft" spellcheck="false" style="width:300px;height:100px;" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="Ok" /></div>'),b=d("#xhePastetextValue",a);d("#xheSave",a).click(function(){c.loadBookmark();var a=b.val();a&&c.pasteText(a);
c.hidePanel();return!1});c.saveBookmark();c.showDialog(a)};this.showLink=function(){var a='<div><label for="xheLinkUrl">Link URL: </label><input type="text" id="xheLinkUrl" value="http://" class="xheText" /></div><div><label for="xheLinkTarget">Target:&nbsp;&nbsp; </label><select id="xheLinkTarget"><option selected="selected" value="">Default</option><option value="_blank">New window</option><option value="_self">Same window</option><option value="_parent">Parent window</option></select></div><div style="display:none"><label for="xheLinkText">Link Text:</label><input type="text" id="xheLinkText" value="" class="xheText" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="Ok" /></div>',
b=ga.find("a[name]").not("[href]"),e=0<b.length;if(e){var f=[];b.each(function(){var a=d(this).attr("name");f.push('<option value="#'+a+'">'+a+"</option>")});a=a.replace(/(<div><label for="xheLinkTarget)/,'<div><label for="xheLinkAnchor">Anchor: &nbsp;&nbsp;</label><select id="xheLinkAnchor"><option value="">None selected</option>'+f.join("")+"</select></div>$1")}var a=d(a),h=c.getParent("a"),n=d("#xheLinkText",a),j=d("#xheLinkUrl",a),l=d("#xheLinkTarget",a),b=d("#xheSave",a),u=c.getSelect();e&&a.find("#xheLinkAnchor").change(function(){var a=
d(this).val();""!=a&&j.val(a)});if(1===h.length){if(!h.attr("href"))return w=null,c.exec("Anchor");j.val(L(h,"href"));l.attr("value",h.attr("target"))}else""===u&&n.val(g.defLinkText).closest("div").show();g.upLinkUrl&&c.uploadInit(j,g.upLinkUrl,g.upLinkExt);b.click(function(){c.loadBookmark();var a=j.val();(""===a||0===h.length)&&c._exec("unlink");if(""!==a&&"http://"!==a){var b=a.split(" "),e=l.val(),f=n.val();if(1<b.length){c._exec("unlink");u=c.getSelect();var g='<a href="xhe_tmpurl"',Z=[];""!==
e&&(g+=' target="'+e+'"');for(var g=g+">xhe_tmptext</a>",f=""!==u?u:f?f:a,i=0,pb=b.length;i<pb;i++)a=b[i],""!==a&&(a=a.split("||"),e=g,e=e.replace("xhe_tmpurl",a[0]),e=e.replace("xhe_tmptext",a[1]?a[1]:f),Z.push(e));c.pasteHTML(Z.join("&nbsp;"))}else a=b[0].split("||"),f||(f=a[0]),f=a[1]?a[1]:""!==u?"":f?f:a[0],0===h.length?(f?c.pasteHTML('<a href="#xhe_tmpurl">'+f+"</a>"):c._exec("createlink","#xhe_tmpurl"),h=d('a[href$="#xhe_tmpurl"]',k)):f&&!R&&h.text(f),L(h,"href",a[0]),""!==e?h.attr("target",
e):h.removeAttr("target")}c.hidePanel();return!1});c.saveBookmark();c.showDialog(a)};this.showAnchor=function(){var a=d('<div><label for="xheAnchorName">Anchor name: </label><input type="text" id="xheAnchorName" value="" class="xheText" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="Ok" /></div>'),b=c.getParent("a"),e=d("#xheAnchorName",a),f=d("#xheSave",a);if(1===b.length){if(b.attr("href"))return w=null,c.exec("Link");e.val(b.attr("name"))}f.click(function(){c.loadBookmark();
var a=e.val();a?0===b.length?c.pasteHTML('<a name="'+a+'"></a>'):b.attr("name",a):1===b.length&&b.remove();c.hidePanel();return!1});c.saveBookmark();c.showDialog(a)};this.showImg=function(){var a=d('<div><label for="xheImgUrl">Img URL:&nbsp; </label><input type="text" id="xheImgUrl" value="http://" class="xheText" /></div><div><div><label for="xheImgAlt">Alt text: </label><input type="text" id="xheImgAlt" /></div><div><label for="xheImgAlign">Alignment:</label><select id="xheImgAlign"><option selected="selected" value="">Default</option><option value="left">Left</option><option value="right">Right</option><option value="top">Top</option><option value="middle">Middle</option><option value="baseline">Baseline</option><option value="bottom">Bottom</option></select></div><div><label for="xheImgWidth">Width:&nbsp; &nbsp; </label><input type="text" id="xheImgWidth" style="width:40px;" /> <label for="xheImgHeight">Height:&nbsp; &nbsp;</label><input type="text" id="xheImgHeight" style="width:40px;" /></div><div><label for="xheImgBorder">Border:&nbsp; &nbsp;</label><input type="text" id="xheImgBorder" style="width:40px;" /></div><div><label for="xheImgHspace">Hspace:&nbsp;&nbsp;&nbsp;</label><input type="text" id="xheImgHspace" style="width:40px;" /> <label for="xheImgVspace">Vspace:&nbsp; &nbsp;</label><input type="text" id="xheImgVspace" style="width:40px;" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="Ok" /></div>'),
...
var i=d(".xheFile",h);i.change(function(){c.startUpload(i[0],b,e,f)});setTimeout(function(){a.closest(".xheDialog").bind("dragenter dragover",N).bind("drop",function(a){var a=a.originalEvent.dataTransfer,d;j&&a&&(d=a.files)&&0<d.length&&c.startUpload(d,b,e,f);return!1})},10)}};this.startUpload=function(a,b,e,f){function h(a,e){var d=Object,g=!1;try{d=eval("("+a+")")}catch(h){}d.err===$||d.msg===$?alert(b+" upload interface error!\r\n\r\nreturn error:\r\n\r\n"+a):d.err?alert(d.err):(n.push(d.msg),
g=!0);(!g||e)&&c.removeModal();e&&g&&f(n);return g}var n=[],j=g.html5Upload,l=j?g.upMultiple:1,i,r=d('<div style="padding:22px 0;text-align:center;line-height:30px;">File uploading,please wait...<br /></div>'),s='<img src="'+ua+'img/loading.gif">';if(Ca||!j||a.nodeType&&(!(i=a.files)||!i[0].name)){if(!Wa(a.value,e))return;r.append(s);e=new c.html4Upload(a,b,h)}else{i||(i=a);a=i.length;if(a>l){alert("Please do not upload more then "+l+" files.");return}for(l=0;l<a;l++)if(!Wa(i[l].name,e))return;var k=
d('<div class="xheProgress"><div><span>0%</span></div></div>');r.append(k);e=new c.html5Upload("filedata",i,b,h,function(a){if(0<=a.loaded){var b=Math.round(100*a.loaded/a.total)+"%";d("div",k).css("width",b);d("span",k).text(b+" ( "+Xa(a.loaded)+" / "+Xa(a.total)+" )")}else k.replaceWith(s)})}c.showModal("File uploading(Esc cancel)",r,320,150);e.start()};this.html4Upload=function(a,b,c){var f="jUploadFrame"+(new Date).getTime(),g=this,i=d('<iframe name="'+f+'" class="xheHideArea" />').appendTo("body"),
j=d('<form action="'+b+'" target="'+f+'" method="post" enctype="multipart/form-data" class="xheHideArea"></form>').appendTo("body"),l=d(a),k=l.clone().attr("disabled","true");l.before(k).appendTo(j);this.remove=function(){null!==g&&(k.before(l).remove(),i.remove(),j.remove(),g=null)};this.onLoad=function(){var a=i[0].contentWindow.document,b=d(a.body).text();a.write("");g.remove();c(b,!0)};this.start=function(){j.submit();i.load(g.onLoad)};return this};this.html5Upload=function(a,b,c,d,g){function i(b,
c,e,d){l=new XMLHttpRequest;upload=l.upload;l.onreadystatechange=function(){4===l.readyState&&e(l.responseText)};upload?upload.onprogress=function(a){d(a.loaded)}:d(-1);l.open("POST",c);l.setRequestHeader("Content-Type","application/octet-stream");l.setRequestHeader("Content-Disposition",'attachment; name="'+encodeURIComponent(a)+'"; filename="'+encodeURIComponent(b.name)+'"');l.sendAsBinary&&b.getAsBinary?l.sendAsBinary(b.getAsBinary()):l.send(b)}function j(a){g&&g({loaded:s+a,total:o})}for(var l,
k=0,r=b.length,s=0,o=0,m=this,p=0;p<r;p++)o+=b[p].size;this.remove=function(){l&&(l.abort(),l=null)};this.uploadNext=function(a){a&&(s+=b[k-1].size,j(0));(!a||a&&!0===d(a,k===r))&&k<r&&i(b[k++],c,m.uploadNext,function(a){j(a)})};this.start=function(){m.uploadNext()}};this.showIframeModal=function(a,b,e,f,g,i){function j(){try{s.callback=l,s.unloadme=c.removeModal,d(s.document).keydown(H),o=s.name}catch(a){}}function l(a){s.document.write("");c.removeModal();null!=a&&e(a)}var b=d('<iframe frameborder="0" src="'+
b.replace(/{editorRoot}/ig,K)+(/\?/.test(b)?"&":"?")+"parenthost="+location.host+'" style="width:100%;height:100%;display:none;" /><div class="xheModalIfmWait"></div>'),k=b.eq(0),r=b.eq(1);c.showModal(a,b,f,g,i);var s=k[0].contentWindow,o;j();k.load(function(){j();if(o){var a=!0;try{o=eval("("+unescape(o)+")")}catch(b){a=!1}if(a)return l(o)}r.is(":visible")&&(k.show().focus(),r.remove())})};this.showModal=function(a,b,e,f,h){if(ta)return!1;c.panelState=S;S=!1;ea=g.layerShadow;e=e?e:g.modalWidth;f=
f?f:g.modalHeight;J=d('<div class="xheModal" style="width:'+(e-1)+"px;height:"+f+"px;margin-left:-"+Math.ceil(e/2)+"px;"+(i&&7>pa?"":"margin-top:-"+Math.ceil(f/2)+"px")+'">'+(g.modalTitle?'<div class="xheModalTitle"><span class="xheModalClose" title="Close (Esc)" tabindex="0" role="button"></span>'+a+"</div>":"")+'<div class="xheModalContent"></div></div>').appendTo("body");Fa=d('<div class="xheModalOverlay"></div>').appendTo("body");0<ea&&(Ea=d('<div class="xheModalShadow" style="width:'+J.outerWidth()+
"px;height:"+J.outerHeight()+"px;margin-left:-"+(Math.ceil(e/2)-ea-2)+"px;"+(i&&7>pa?"":"margin-top:-"+(Math.ceil(f/2)-ea-2)+"px")+'"></div>').appendTo("body"));d(".xheModalContent",J).css("height",f-(g.modalTitle?d(".xheModalTitle").outerHeight():0)).html(b);i&&6===pa&&(Ga=d("select:visible").css("visibility","hidden"));d(".xheModalClose",J).click(c.removeModal);Fa.show();0<ea&&Ea.show();J.show();setTimeout(function(){J.find("a,input[type=text],textarea").filter(":visible").filter(function(){return"hidden"!==
d(this).css("visibility")}).eq(0).focus()},10);ta=!0;Ha=h};this.removeModal=function(){Ga&&Ga.css("visibility","visible");J.html("").remove();0<ea&&Ea.remove();Fa.remove();Ha&&Ha();ta=!1;S=c.panelState};this.showDialog=function(a,b){var e=d('<div class="xheDialog"></div>'),f=d(a),h=d("#xheSave",f);if(1===h.length){f.find("input[type=text],select").keypress(function(a){if(13===a.which)return h.click(),!1});f.find("textarea").keydown(function(a){if(a.ctrlKey&&13===a.which)return h.click(),!1});h.after(' <input type="button" id="xheCancel" value="Cancel" />');
d("#xheCancel",f).click(c.hidePanel);if(!g.clickCancelDialog){sa=!1;var i=d('<div class="xheFixCancel"></div>').appendTo("body").mousedown(N),j=A.offset();i.css({left:j.left,top:j.top,width:A.outerWidth(),height:A.outerHeight()})}e.mousedown(function(){oa=!0})}e.append(f);c.showPanel(e,b)};this.showPanel=function(a,b){if(!w.target)return!1;t.html("").append(a).css("left",-999).css("top",-999);da=d(w.target).closest("a").addClass("xheActive");var c=da.offset(),f=c.left,c=c.top,c=c+(da.outerHeight()-
1);ca.css({left:f+1,top:c,width:da.width()}).show();var h=document.documentElement,i=document.body;if(f+t.outerWidth()>(window.pageXOffset||h.scrollLeft||i.scrollLeft)+(h.clientWidth||i.clientWidth))f-=t.outerWidth()-da.outerWidth();h=g.layerShadow;0<h&&ba.css({left:f+h,top:c+h,width:t.outerWidth(),height:t.outerHeight()}).show();if((h=d("#"+ja).offsetParent().css("zIndex"))&&!isNaN(h))ba.css("zIndex",parseInt(h,10)+1),t.css("zIndex",parseInt(h,10)+2),ca.css("zIndex",parseInt(h,10)+3);t.css({left:f,
top:c}).show();b||setTimeout(function(){t.find("a,input[type=text],textarea").filter(":visible").filter(function(){return"hidden"!==d(this).css("visibility")}).eq(0).focus()},10);Qa=S=!0};this.hidePanel=function(){S&&(da.removeClass("xheActive"),ba.hide(),ca.hide(),t.hide(),S=!1,sa||(d(".xheFixCancel").remove(),sa=!0),Qa=oa=!1,X=null,c.focus(),c.loadBookmark())};this.exec=function(a){c.hidePanel();var b=ka[a];if(!b)return!1;if(null===w){w={};var e=q.find(".xheButton[cmd="+a+"]");if(1===e.length)w.target=
e}if(b.e)b.e.call(c);else switch(a=a.toLowerCase(),a){case "cut":try{if(k.execCommand(a),!k.queryCommandSupported(a))throw"Error";}catch(f){alert("Currently not supported by your browser, use keyboard shortcuts(Ctrl+X) instead.")}break;case "copy":try{if(k.execCommand(a),!k.queryCommandSupported(a))throw"Error";}catch(h){alert("Currently not supported by your browser, use keyboard shortcuts(Ctrl+C) instead.")}break;case "paste":try{if(k.execCommand(a),!k.queryCommandSupported(a))throw"Error";}catch(o){alert("Currently not supported by your browser, use keyboard shortcuts(Ctrl+V) instead.")}break;
