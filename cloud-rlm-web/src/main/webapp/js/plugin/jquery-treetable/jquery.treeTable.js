    ...
    if(!node.hasClass("initialized")) {
      ...
      if(node.hasClass("parent")) {
        ...
        if(options.expandable) {
          var newLink = '<a href="#" title="' + options.stringExpand + '" style="margin-left: -' + options.indent + 'px; padding-left: ' + options.indent + 'px" class="expander">{0}</a>';

          if(options.clickableNodeNames) {
            cell.wrapInner(newLink.format(''));
          } else {
            cell.html(newLink.format(cell.html()));
          }
